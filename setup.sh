...
_wg_show_instructions() {
    ...
    case $device_type in
        ...
        2)  # Linux
            ...
            echo ""
            echo -e "  On your laptop, run ${BOLD}fedvpn${NC} → ${BOLD}1 (setup)${NC}"
            echo -e "  It installs WireGuard and asks you to paste the config below."
            echo ""
            echo -e "  If you don't have fedvpn yet:"
            echo -e "    ${BOLD}cd ~/PycharmProjects/privcloud${NC}"
            echo -e "    ${BOLD}sudo cp fedvpn /usr/local/bin/fedvpn${NC}"
            echo ""
            echo -e "  ${BOLD}Copy this entire config:${NC}"
            echo -e "  ${DIM}───────────────────────────────────────${NC}"
            echo "$peer_conf"
            echo -e "  ${DIM}───────────────────────────────────────${NC}"
            echo ""
            echo -e "  After pasting in fedvpn setup:"
            echo -e "    ${BOLD}fedvpn${NC} → ${BOLD}2${NC} to connect"
            echo -e "    ${BOLD}fedvpn${NC} → ${BOLD}3${NC} to disconnect"
            echo -e "  ${YELLOW}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
            ;;
        3)  # Mac
            echo -e "  ${YELLOW}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
