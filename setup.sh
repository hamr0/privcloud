...
PersistentKeepalive = 25"
    ...
    echo -e "    ${BOLD}scp ahassan@${endpoint}:${WG_DIR}/<peer-name>.conf /tmp/wg.conf${NC}"
    ...
    echo ""
    echo -e "  ${BOLD}Mac:${NC} App Store → WireGuard → import config file"
    echo -e "  ${BOLD}Windows:${NC} wireguard.com/install → paste config"
    echo -e "  ${YELLOW}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
}
